    ...
    public String generateDigest() {
        ...
        if(digest != null) {
            ...
            try {
                ...
                fout.write(digest.getBytes(), 0, digest.getBytes().length);
            } catch (IOException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
            } finally {
    ...
    class ReduceCopier<K, V> implements MRConstants {
        ...
        private class InMemFSMergeThread extends Thread {
            ...
            private void doInMemMerge() throws IOException{
                ...
                String d = h.generateHashForReduce(rfs, outputPath);
                LOG.debug("Digest for " + mapId.toString() + " ( " + outputPath.toString() + " ) = " + d);
            }
        }
            ...
            private int getMapCompletionEvents() throws IOException {
                ...
                for (TaskCompletionEvent event : events) {
                    ...
                    case SUCCEEDED:
                    {
                        ...
                        if(LOG.isDebugEnabled()) {
                            if(event.getDigests() == null)
                                LOG.debug("NULL");
                            String[] d = event.getDigests();
