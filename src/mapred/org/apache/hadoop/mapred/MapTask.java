    ...
    implements MapOutputCollector<K, V>, IndexedSortable {
        ...
        private String[] generateHash(Path finalOutputFile, SpillRecord spillRec) throws IOException {
            ...
            for(int part=0; part<spillRec.size(); part++) {
                ...
                if(codec != null) {
                    hashList[part] = hashGen.generateHash(rfs, finalOutputFile, (int) index.startOffset, (int) index.partLength);
                } else {
                    hashList[part] = hashGen.generateHash(rfs, finalOutputFile, (int) index.startOffset, (int) index.rawLength);
                }
            }
            ...
            LOG.debug("Map digests" + Arrays.deepToString(hashList));
